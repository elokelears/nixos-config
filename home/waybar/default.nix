  ...
  xdg.configFile = {
    "waybar/config".text = ''

      {
        ...
        "modules-center": ["hyprland/window", "idle_inhibitor"],
        ...
        "idle_inhibitor": {
          "format": "{icon}",
          "format-icons": {
            "activated": "<span size='13000' foreground='#${config.lib.stylix.colors.base0A}'></span>",
            "deactivated": "<span size='13000' foreground='#${config.lib.stylix.colors.base0A}'></span>"
          }
        },
